...
class PolymodHandler
{
  ...
  public static final API_VERSION_RULE:String = '>=0.0.1 <0.1.0';
  ...
  static function blacklistPackage(pkg:String):Void
  {
  ...
  static function buildImports():Void
  {
    ...
    blacklistPackage('extension.androidtools');
    blacklistPackage('extension.haptics');
    blacklistPackage('extension.admob');
    blacklistPackage('extension.iapcore');
    blacklistPackage('extension.iarcore');
    blacklistPackage('extension.webviewcore');
